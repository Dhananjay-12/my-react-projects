...
export default function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    delete:
      "inline-block text-sm rounded-full bg-red-500 font-semibold uppercase tracking-wide text-white transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed" +
      "bg-red-500 px-2.5 py-1 md:px-3.5 md:py-2 text-sm",
  };
